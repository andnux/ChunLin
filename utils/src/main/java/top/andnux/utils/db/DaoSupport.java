...
public class DaoSupport<T> implements IDaoSupport<T> {
    ...
    public List<T> query(T where) {
        ...
        WhereHandle whereHandle = new WhereHandle(where);
        Cursor cursor = mSqLiteDatabase.query(DaoUtil.getTableName(mClazz), null, whereHandle.getWhereClause(),
    ...
    public int update(T data, T where) {
        ...
        WhereHandle whereHandle = new WhereHandle(where);
        return mSqLiteDatabase.update(DaoUtil.getTableName(mClazz), values,
    ...
    public int delete(T where) {
        WhereHandle whereHandle = new WhereHandle(where);
        return mSqLiteDatabase.delete(DaoUtil.getTableName(mClazz), whereHandle.getWhereClause(),
